  ...
  return modelStorage.downloadGgufModel({
    ...
    onProgress: (progress) => {
      ...
      if (win && !win.isDestroyed()) {
        win.webContents.send("gguf:progress", progress);
      }
    },
  });
});
