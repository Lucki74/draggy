...
/** One string in the user's language. English is the fallback, and the key itself is the last
 * resort, so a string added mid-feature shows its name rather than an empty space. */
