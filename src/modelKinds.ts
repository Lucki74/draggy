 ...
 * not an answer, and reads as no objection. */
...
/** Narrows installed models to the ones worth offering, in chat and Talk alike: both rule out
 * exactly the models that cannot generate text. */
